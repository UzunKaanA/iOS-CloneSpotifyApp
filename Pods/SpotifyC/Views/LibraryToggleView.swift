...
class LibraryToggleView: UIView {
  ...
  private let feelingLuckyButton: UIButton = {
    ...
    override init(frame: CGRect) {
      ...
      feelingLuckyButton.addTarget(self, action: #selector(didTapFeelingLucky), for: .touchUpInside)
    }
    ...
    // Button actions
  @objc func didTapFeelingLucky() {
        state = .feelingLucky
        delegate?.libraryToggleViewDidTapFeelingLucky(self)
  }
    ...
    override func layoutSubviews() {
      ...
      feelingLuckyButton.snp.makeConstraints { make in
          make.top.equalTo(10)
          make.left.equalTo(albumButton.snp.right).offset(10)
          make.width.equalTo(100)
          make.height.equalTo(44)
      }
    ...
    private func layoutIndicator() {
        ...
        case .feelingLucky:
          indicatorView.frame = CGRect(x: 230, y: playlistButton.bottom, width: 100, height: 3)
        }
    }
